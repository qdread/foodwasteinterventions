...
wb_fat1 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/fatsandpreparedfoods_q1.xls'))
...
wb_fruitveg1 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/fruitsandvegetables_q1.xls'))
...
wb_graindairy1 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/grainsanddairy_q1.xls'))
...
wb_meategg1 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/meatsandeggs_q1.xls'))
...
wb_fat2 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/qfahpd2fatsandpreparedfoods.xls'))
...
wb_fruitveg2 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/qfahpd2fruitsandvegetables.xls'))
...
wb_graindairy2 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/qfahpd2grainsanddairy.xls'))
...
wb_meategg2 <- loadWorkbook(file.path(fp_rawdata, 'raw/QFAHPD/qfahpd2meatsandeggs.xls'))
