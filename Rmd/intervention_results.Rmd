...
```{r table1}
kable(table_costbreakdown, "latex", booktabs = T) %>%
...
```{r table2}
kable(table_costbreakdown_alternate, "latex", booktabs = T) %>%
  kable_styling(font_size = 7)
```
...
```{r table3}
kable(table_netcost, "latex", booktabs = T) %>%
  kable_styling(font_size = 7)
```
...
```{r table4}
kable(table_netcost_alternate, "latex", booktabs = T) %>%
  kable_styling(font_size = 7)
```
